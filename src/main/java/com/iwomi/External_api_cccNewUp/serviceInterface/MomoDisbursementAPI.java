 ...
 * @author user
 */
public interface MomoDisbursementAPI {
    
    public String getToken( String apiUser, String apiKey, String subKey);
    
    public Map<String, String> performPayment(String amount,String number, String payerMsg, String payeeMsg, String currency,String token, String subKey,String s);
